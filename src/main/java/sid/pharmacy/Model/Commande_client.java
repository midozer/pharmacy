...
public class Commande_client {
	...
	@ManyToMany
	@JoinTable(name = "Produits_CmdClient_Associations",joinColumns = @JoinColumn(name="id_cmd"),
	...
	private Facture_client facture_client;
	...
	public Commande_client(Date date_cmd, String lieu_cmd, Client client, List<Produit> produits,
			Mode_paiement mode_paiement, Facture_client facture_client, Livraison livraison, Pharmacien pharmacien) {
		super();
	...
	public Facture_client getFacture_client() {
