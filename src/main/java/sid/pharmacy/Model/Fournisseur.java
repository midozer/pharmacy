...
public class Fournisseur {
	...
	public Fournisseur(String nom_fournisseur, String prenom_fournisseur, int tele_fournisseur,
			String adresse_fournisseur, String ville_fournisseur) {
		super();
		this.nom_fournisseur = nom_fournisseur;
		this.prenom_fournisseur = prenom_fournisseur;
		this.tele_fournisseur = tele_fournisseur;
	...
	public int getTele_fournisseur() {
		return tele_fournisseur;
	}
	public void setTele_fournisseur(int tele_fournisseur) {
		this.tele_fournisseur = tele_fournisseur;
	}
