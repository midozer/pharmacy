...
public class Livreur {
	...
	public Livreur(String nom_livreur, String prenom_livreur, int tele_livreur, String cin_livreur,
			Pharmacie pharmacie) {
		super();
	...
	public int getId_liveur() {
		return id_liveur;
	}
	public void setId_liveur(int id_liveur) {
		this.id_liveur = id_liveur;
	}
	...
	public int getTele_livreur() {
		return tele_livreur;
	}
	public void setTele_livreur(int tele_livreur) {
		this.tele_livreur = tele_livreur;
	}
