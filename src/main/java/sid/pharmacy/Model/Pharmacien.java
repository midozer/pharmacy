...
public class Pharmacien{
	...
	@ManyToMany
	@JoinTable(name = "T_Pharmacien_CommandeClient",joinColumns = @JoinColumn(name="id_pharmacien"),
	...
	public Pharmacien(String nom_pharmacien, String prenom_pharmacien, int tele_pharmacien, Pharmacie pharmacie) {
		super();
		this.nom_pharmacien = nom_pharmacien;
		this.prenom_pharmacien = prenom_pharmacien;
		this.tele_pharmacien = tele_pharmacien;
	...
	public int getTele_pharmacien() {
		return tele_pharmacien;
	}
	public void setTele_pharmacien(int tele_pharmacien) {
		this.tele_pharmacien = tele_pharmacien;
	}
